    ...
    <div class="head">
      ...
      <div class="help_head_text">
        ...
        <p>
          ...
          needs of the users.[1] Wiki engines usually allow content to be
          written using a simplified markup language and sometimes edited with
          the help of a rich-text editor.[2] There are dozens of different wiki
          engines in use, both standalone and part of other software, such as
          bug tracking systems. Some wiki engines are open source, whereas
...
.help_box .head .help_head_text {
  padding: 20px 100px;
}

.help_box .head .help_head_text h1 {
  font-size: 80px;
}

.help_box .head .help_head_text p {
  font-size: 20px;
}
